...
namespace TransitSystem.Controllers
{
    public class RouteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RouteID,RouteName,LocationID,LocationPositionInRoute")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RouteID,RouteName,LocationID,LocationPositionInRoute")] Route route)
        {
            if (ModelState.IsValid)
            {
